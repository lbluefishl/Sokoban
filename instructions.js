...
const instructions = [
    ...
    "<h1>Task Description</h1>You will now be asked to complete a series of Sokoban puzzles. These are classic problems where you push boxes around a warehouse towards storage locations. These problems are difficult for humans and computers. <br><br><div style='text-align:center'><img src='images/sokoban.gif' alt='Animated GIF'></div><br> It is natural to have trouble completing some puzzles. Please continue to work on the puzzles even if you find yourself stuck on them. You can use the <b>r</b> key on the keyboard to restart the level as many times as you need. We are interested in how you try to solve each puzzle, not necessarily whether you complete them or not. <b><u>Your compensation does not increase if you solve the puzzles</u></b>. We are only interested in individual problem solving behavior. As such, please do not seek external help in order to complete the puzzles. You will be paid the full amount as long as you are working on the puzzles actively. Please remain active during this study and do not work on other tasks. <b><u>An additional $1 will be awarded for reasonable effort on the tasks</u></b>. Failure to stay reasonably active will result in a rejection.<br><br> <b><u>If you do not think you can stay reasonably active (staying on the computer, adequate effort for the tasks) for the full duration of this study (~35 minutes maximum, 20 minutes average), please close the browser now to end the study and avoid a rejection.</u></b> <br><br> During the study, you may be given short breaks after working on a puzzle for a few minutes. During these breaks please follow the instructions on the screen and <b><u>remain on the computer</u></b>. Please enable computer audio for use on some tasks. You will be automatically directed back to the puzzles after a few minutes.<br><br> It is important that you <b><u>do not press the back and refresh buttons</u></b> on your browser while you are working on this study. You are free to exit this study at any time by simply closing your browser. If you go back pages, refresh the page, or exit the study, your data will not be used and you will not be compensated for your time.<br><br>    </h1>",
